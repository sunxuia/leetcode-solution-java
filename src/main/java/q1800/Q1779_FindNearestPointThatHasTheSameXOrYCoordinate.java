...
public class Q1779_FindNearestPointThatHasTheSameXOrYCoordinate {
    ...
    public DataExpectation example1 = DataExpectation
            .createWith(3, 4, new int[][]{{1, 2}, {3, 1}, {2, 4}, {2, 3}, {4, 4}})
            .expect(2);

    @TestData
    public DataExpectation example2 = DataExpectation
            .createWith(3, 4, new int[][]{{3, 4}})
            .expect(0);

    @TestData
    public DataExpectation example3 = DataExpectation
            .createWith(3, 4, new int[][]{{2, 3}})
            .expect(-1);
