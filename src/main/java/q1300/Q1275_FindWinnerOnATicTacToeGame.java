 ...
 *
 * 题解: 这题中只要没满 9 步且没有胜者, 都算 Pending, 满了9 步且没有胜者才算 Draw.
 */
...
public class Q1275_FindWinnerOnATicTacToeGame {
    ...
    public String tictactoe(int[][] moves) {
        ...
        for (int i = 0; i < moves.length; i++) {
            table[moves[i][0]][moves[i][1]] = 2 - i % 2;
        }
        if (isWin(table, 2)) {
            return "A";
        }
    ...
    private boolean isWin(int[][] table, int value) {
        return table[0][0] == value && table[0][1] == value && table[0][2] == value
    ...
    public DataExpectation example1 = DataExpectation
            .create(new int[][]{{0, 0}, {2, 0}, {1, 1}, {2, 1}, {2, 2}})
            .expect("A");

    @TestData
    public DataExpectation example2 = DataExpectation
            .create(new int[][]{{0, 0}, {1, 1}, {0, 1}, {0, 2}, {1, 0}, {2, 0}})
            .expect("B");

    @TestData
    public DataExpectation example3 = DataExpectation
            .create(new int[][]{{0, 0}, {1, 1}, {2, 0}, {1, 0}, {1, 2}, {2, 1}, {0, 1}, {0, 2}, {2, 2}})
            .expect("Draw");

    @TestData
    public DataExpectation example4 = DataExpectation
            .create(new int[][]{{0, 0}, {1, 1}})
            .expect("Pending");

    @TestData
    public DataExpectation normal1 = DataExpectation
            .create(new int[][]{{1, 1}, {2, 0}, {0, 2}})
            .expect("Pending");

    @TestData
    public DataExpectation normal2 = DataExpectation
            .create(new int[][]{{2, 0}, {0, 2}, {0, 0}, {2, 2}, {1, 1}, {1, 0}, {2, 1}, {0, 1}})
            .expect("Pending");
