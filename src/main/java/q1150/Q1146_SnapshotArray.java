 ...
 * int snap() takes a snapshot of the array and returns the snap_id: the total number of times we called snap() minus
 * 1.
...
public class Q1146_SnapshotArray {
    ...
    private static class SnapshotArray {
        ...
        final TreeMap<Integer, Integer>[] arr;
        ...
        public int get(int index, int snap_id) {
            return arr[index].lowerEntry(snap_id).getValue();
        }
    }
    ...
    public void testMethod() {
        ...
        snapshotArr.set(0, 5);
        Assert.assertEquals(0, snapshotArr.snap());
        snapshotArr.set(0, 6);
        Assert.assertEquals(5, snapshotArr.get(0, 0));
    }
