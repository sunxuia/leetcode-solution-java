...
/**
 * [Medium] 1884. Egg Drop With 2 Eggs and N Floors
 ...
 * - Drop the 1st egg at floor 9. If it breaks, we know f is between 0 and 8. Drop the 2nd egg starting from floor 1 and
 * going up one at a time to find f within 8 more drops. Total drops is 1 + 8 = 9.
 * - If the 1st egg does not break, drop the 1st egg again at floor 22. If it breaks, we know f is between 9 and 21.
 * Drop the 2nd egg starting from floor 10 and going up one at a time to find f within 12 more drops. Total drops is 2 +
 * 12 = 14.
...
public class Q1884_EggDropWith2EggsAndNFloors {
    ...
    @TestData
    public DataExpectation example1 = DataExpectation.create(2).expect(2);

    @TestData
    public DataExpectation example2 = DataExpectation.create(100).expect(14);
