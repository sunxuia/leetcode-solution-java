...
public class Q1880_CheckIfWordEqualsSummationOfTwoWords {
    ...
    @TestData
    public DataExpectation example1 = DataExpectation.createWith("acb", "cba", "cdb").expect(true);

    @TestData
    public DataExpectation example2 = DataExpectation.createWith("aaa", "a", "aab").expect(false);

    @TestData
    public DataExpectation example3 = DataExpectation.createWith("aaa", "a", "aaaa").expect(true);
