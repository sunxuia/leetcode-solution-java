...
public class Q1945_SumOfDigitsOfStringAfterConvert {
    ...
    @TestData
    public DataExpectation example1 = DataExpectation.createWith("iiii", 1).expect(36);

    @TestData
    public DataExpectation example2 = DataExpectation.createWith("leetcode", 2).expect(6);

    @TestData
    public DataExpectation example3 = DataExpectation.createWith("zbax", 2).expect(8);
