...
public class Q1663_SmallestStringWithAGivenNumericValue {
    ...
    public String getSmallestString(int n, int k) {
        ...
        return new String(resCs);
    }

    @TestData
    public DataExpectation example1 = DataExpectation.createWith(3, 27).expect("aay");

    @TestData
    public DataExpectation example2 = DataExpectation.createWith(5, 73).expect("aaszz");
