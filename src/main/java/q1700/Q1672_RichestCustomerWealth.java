...
public class Q1672_RichestCustomerWealth {
    ...
    @TestData
    public DataExpectation example1 = DataExpectation.create(new int[][]{{1, 2, 3}, {3, 2, 1}}).expect(6);

    @TestData
    public DataExpectation example2 = DataExpectation.create(new int[][]{{1, 5}, {7, 3}, {3, 5}}).expect(10);

    @TestData
    public DataExpectation example3 = DataExpectation.create(new int[][]{{2, 8, 7}, {7, 1, 3}, {1, 9, 5}}).expect(17);
