...
public class Q1823_FindTheWinnerOfTheCircularGame {
    ...
    @TestData
    public DataExpectation example1 = DataExpectation.createWith(5, 2).expect(3);

    @TestData
    public DataExpectation example2 = DataExpectation.createWith(6, 5).expect(1);
