...
/**
 * [Medium] 2038. Remove Colored Pieces if Both Neighbors are the Same Color
...
public class Q2038_RemoveColoredPiecesIfBothNeighborsAreTheSameColor {
    ...
    @TestData
    public DataExpectation example1 = DataExpectation.create("AAABABB").expect(true);

    @TestData
    public DataExpectation example2 = DataExpectation.create("AA").expect(false);

    @TestData
    public DataExpectation example3 = DataExpectation.create("ABBBBBBBAAA").expect(false);
