...
public class Q1649_CreateSortedArrayThroughInstructions {
    ...
    public int createSortedArray(int[] instructions) {
        ...
        for (int value : instructions) {
            ...
            int more = query(tree, max) - query(tree, value);
    ...
    @TestData
    public DataExpectation example1 = DataExpectation.create(new int[]{1, 5, 6, 2}).expect(1);

    @TestData
    public DataExpectation example2 = DataExpectation.create(new int[]{1, 2, 3, 6, 5, 4}).expect(3);

    @TestData
    public DataExpectation example3 = DataExpectation.create(new int[]{1, 3, 3, 3, 2, 4, 2, 1, 2}).expect(4);
