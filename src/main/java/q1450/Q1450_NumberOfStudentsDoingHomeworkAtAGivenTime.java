...
public class Q1450_NumberOfStudentsDoingHomeworkAtAGivenTime {
    ...
    public DataExpectation example1 = DataExpectation
            .createWith(new int[]{1, 2, 3}, new int[]{3, 2, 7}, 4)
            .expect(1);

    @TestData
    public DataExpectation example2 = DataExpectation
            .createWith(new int[]{4}, new int[]{4}, 4)
            .expect(1);

    @TestData
    public DataExpectation example3 = DataExpectation
            .createWith(new int[]{4}, new int[]{4}, 5)
            .expect(0);

    @TestData
    public DataExpectation example4 = DataExpectation
            .createWith(new int[]{1, 1, 1, 1}, new int[]{1, 3, 2, 4}, 7)
            .expect(0);

    @TestData
    public DataExpectation example5 = DataExpectation
            .createWith(new int[]{9, 8, 7, 6, 5, 4, 3, 2, 1}, new int[]{10, 10, 10, 10, 10, 10, 10, 10, 10}, 5)
            .expect(5);
