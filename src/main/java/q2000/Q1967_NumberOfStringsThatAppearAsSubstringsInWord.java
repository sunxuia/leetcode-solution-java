...
public class Q1967_NumberOfStringsThatAppearAsSubstringsInWord {
    ...
    public DataExpectation example1 = DataExpectation
            .createWith(new String[]{"a", "abc", "bc", "d"}, "abc")
            .expect(3);

    @TestData
    public DataExpectation example2 = DataExpectation
            .createWith(new String[]{"a", "b", "c"}, "aaaaabbbbb")
            .expect(2);

    @TestData
    public DataExpectation example3 = DataExpectation
            .createWith(new String[]{"a", "a", "a"}, "ab")
            .expect(3);
