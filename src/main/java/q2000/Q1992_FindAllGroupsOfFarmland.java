...
/**
 * [Medium] 1992. Find All Groups of Farmland
...
public class Q1992_FindAllGroupsOfFarmland {
    ...
    public DataExpectation example1 = DataExpectation.create(new int[][]{
                    ...
                    {0, 1, 1},
                    {0, 1, 1}})
            .expect(new int[][]{{0, 0, 0, 0}, {1, 1, 2, 2}})
            .unOrder("");
