...
public class Q1310_XorQueriesOfASubarray {
    ...
    public DataExpectation example1 = DataExpectation
            .createWith(new int[]{1, 3, 4, 8}, new int[][]{{0, 1}, {1, 2}, {0, 3}, {3, 3}})
            .expect(new int[]{2, 7, 14, 8});

    @TestData
    public DataExpectation example2 = DataExpectation
            .createWith(new int[]{4, 8, 2, 10}, new int[][]{{2, 3}, {1, 3}, {0, 0}, {0, 3}})
            .expect(new int[]{8, 0, 4, 4});
