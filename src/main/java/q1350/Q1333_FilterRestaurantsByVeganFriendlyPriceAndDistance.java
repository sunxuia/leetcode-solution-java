...
/**
 * [Medium] 1333. Filter Restaurants by Vegan-Friendly, Price and Distance
 ...
 * After filter restaurants with veganFriendly = 1, maxPrice = 50 and maxDistance = 10 we have restaurant 3, restaurant
 * 1 and restaurant 5 (ordered by rating from highest to lowest).
 *
 * Example 2:
 *
 ...
 * maxPrice = 50, maxDistance = 10
 * Output: [4,3,2,1,5]
 * Explanation: The restaurants are the same as in example 1, but in this case the filter veganFriendly = 0, therefore
 * all restaurants are considered.
 *
 * Example 3:
 *
 * Input: restaurants = [[1,4,1,40,10],[2,8,0,50,5],[3,8,1,30,4],[4,10,0,10,3],[5,1,1,15,1]], veganFriendly = 0,
...
public class Q1333_FilterRestaurantsByVeganFriendlyPriceAndDistance {
